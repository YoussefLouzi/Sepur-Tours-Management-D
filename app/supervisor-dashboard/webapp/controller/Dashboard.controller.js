sap.ui.define([
    ...
    return Controller.extend("sepur.supervisor.controller.Dashboard", {
        ...
        _getSupervisorStats: function () {
            if (!this._statsPromise) {
                const oModel = this.getView().getModel();
                const oContext = oModel.bindContext("/getSupervisorStats(...)");

                this._statsPromise = oContext.execute().then(function () {
        ...
        _loadSalesOrderStats: async function () {
            ...
            viewModel.setProperty("/salesOrderStats", {
                totalSalesOrders: stats.salesOrdersCount || 0
            });
        },
        ...
        _loadHistoryStats: async function () {
            ...
            try {
                ...
                viewModel.setProperty("/historyStats", {
                    ...
                    acceptedDecisions: stats.acceptedDecisions || 0,
                    rejectedDecisions: stats.rejectedDecisions || 0
                });
                ...
                if (roadmapsResponse.ok) {
                    ...
                    if (roadmapsToValidate.length > 0) {
                        notifications.push({
                            ...
                            description: "Des feuilles de route créées par le planificateur attendent une décision."
                        });
                    }
