...
sap.ui.require(
  [
    ...
    "sap/ui/qunit/qunit-junit",
    "sap/ui/qunit/qunit-coverage",
    "sepur/supervisor/supervisortours/test/integration/FirstJourney",
    "sepur/supervisor/supervisortours/test/integration/ToursListJourney",
    "sepur/supervisor/supervisortours/test/integration/ToursObjectPageJourney",
], function (QUnit) {
    "use strict";
    QUnit.start();
});
