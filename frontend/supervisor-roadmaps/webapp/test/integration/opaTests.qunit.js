...
sap.ui.require(
  [
    ...
    "sap/ui/qunit/qunit-junit",
    "sap/ui/qunit/qunit-coverage",
    "sepur/supervisor/supervisorroadmaps/test/integration/FirstJourney",
    "sepur/supervisor/supervisorroadmaps/test/integration/RoadmapsListJourney",
    "sepur/supervisor/supervisorroadmaps/test/integration/RoadmapsObjectPageJourney",
], function (QUnit) {
    "use strict";
    QUnit.start();
});
